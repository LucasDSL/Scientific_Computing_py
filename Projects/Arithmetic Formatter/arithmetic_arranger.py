def arithmetic_arranger(list_sums, option_argument=False):
    ...
    for sum in list_sums:
        ...
        string_return += f"{sum[0]:>{sum[3] + 2}}" # Plus two spaces (1 for the
    ...
    for sum in list_sums:
        ...
        if list_sums[-1] == sum and option_argument:
            string_return += "\n"
        elif list_sums[-1] == sum and not option_argument:
            string_return += ""
        else:
            string_return += "    "
